   <html>
    ...
    <title>Listado Packs</title>    
    </head>
    <body>
    <div class="container">
    <div class="main">
    <h2>Listado Packs</h2><hr>
      ...
      $dbhost = 'localhost:3036';
		...
		if($conn)
		{
			...
			if (isset($_POST["guardar"])) 
			{
				...
				$query = "update packs set descripcion = '$descripcion' where id = '$fila[id]'";
						...
						if(isset($_POST["borrar"])) 
							{
								...
								$fila = $_POST["borrar"];
								$q = "delete from packs where id = '$fila[id]'";
								mysql_select_db('breakTime');
								$res = mysql_query($q);
	...
	while($fila = mysql_fetch_array($retval))
	{
		...
		if ($edito)
		 {
			...
			// Listado con edición
			 echo "<form action='formListarPacks.php' method='post'>";
			 echo "<tr>";		
			 ...
			 <a href='formListarPacks.php' class='btn btn-danger'>Cancelar</a>
			 </td>";
			 echo "</tr>";
			 echo "</form>";		 
		...
		// Listado con borrado
		...
		else
		 {
		     ...
		     echo "<td class='text-nowrap'>";
			 echo '<a href="formListarPacks.php?editar='.$fila['id'].'" class="btn btn-primary">Editar</a>';
			 echo '<a href="formListarPacks.php?borrar='.$fila['id'].'" class="btn btn-danger">Borrar</a>';
			 echo "</td>";
			 echo "</tr>";
				$i++;
		 		$count++;
